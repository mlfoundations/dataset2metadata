...
def create_loader(input_shards, models, additional_fields, nworkers, batch_size, warn_and_continue):
    # import here as registry may have updated
    ...
    map_handler = {"handler": wds.warn_and_continue} if warn_and_continue else {}

    pipeline.extend(
        [
            wds.split_by_worker,
            tarfile_to_samples_nothrow,
            wds.decode("pilrgb", partial(json_decoder, json_keys=additional_fields), **map_handler),
            wds.rename(image="jpg;png;jpeg;webp", text="txt", **map_handler),
