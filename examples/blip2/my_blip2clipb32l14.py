...
class Blip2ClipB32L14Wrapper(nn.Module):
    ...
    raw_inputs = ['image', 'image', 'text'] # static field: provide name of input to process
    preprocessors = ['blip2-aug', 'clip-aug', 'clip-tokens'] # static field: name of preprocessor
    ...
    def forward(self, x_blip, x_clip, t_clip):
        ...
        b32_image_feature = b32_image_feature / b32_image_feature.norm(dim=1, keepdim=True)
        b32_text_feature = b32_text_feature / b32_text_feature.norm(dim=1, keepdim=True)
        b32_generated_text_feature = b32_generated_text_feature / b32_generated_text_feature.norm(dim=1, keepdim=True)
        ...
        l14_generated_text_feature = l14_generated_text_feature / l14_generated_text_feature.norm(dim=1, keepdim=True)

        return b32_image_feature, b32_text_feature, b32_generated_text_feature, l14_image_feature, l14_text_feature, l14_generated_text_feature, generated_text
...
postprocess_parquet_lookup = {
    ...
    'oai-clip-b32-score': partial(batched_dot_product_index, i=0, j=1, model='blip2clipb32l14'),
    'oai-clip-b32-blip2-score': partial(batched_dot_product_index, i=0, j=2, model='blip2clipb32l14'),
    'oai-clip-l14-score': partial(batched_dot_product_index, i=3, j=4, model='blip2clipb32l14'),
    'oai-clip-l14-blip2-score': partial(batched_dot_product_index, i=3, j=5, model='blip2clipb32l14'),
}
